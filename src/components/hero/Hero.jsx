    ...
    <div className="relative  lg:container ">
      <section className="hero-section  md:pb-0 pb-5  flex flex-col  pt-4  lg:flex-row ">
        <div className="mt-10 lg:w-1/2 py-10 " id="element" >
          ...
          <h1 className="hero-head text-4xl mt-4 text-center font-play font-extrabold  text-secondary md:text-5xl lg:text-4xl xl:text-5xl lg:text-left lg:max-w-[540px]" id="animated">
            <span>Tasker brings all</span> <br />
            <span className="mt-9">your tasks Teams &</span> <br /> <span>tools together </span>
          </h1>
          <p id="animated" className="hero-p lg:mx-0 mx-5 font-play text-font-color mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
